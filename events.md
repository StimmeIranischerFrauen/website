...
<div class="event-cards">
  ...
  <a href="{{ '/events/munichfeb2026/' | relative_url }}" class="event-card">
    ...
    <div class="event-card-body">
      <p class="news-date">14.02.2026</p>
      <h3>Global Day of Action (Munich, Germany)</h3>
      <p>In solidarity with Iran's Lion-and-Sun Revolution, a day to take to the streets and compel the international community to take urgent, practical steps in support of the Iranian people.</p>
      <span class="petition-cta">Read more &rarr;</span>
    </div>
  </a>
